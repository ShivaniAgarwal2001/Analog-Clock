...
#define DO do
#define P printf  
#define OTX outtextxy
#define C circle
#define R rectangle
#define FF floodfill
#define SC setcolor
#define IG initgraph
#define CG closegraph
#define RCM restorecrtmode
...
#define G getch      //
#define RE return
#define mal_function if_find_virus
#define use python_code_for_hacking
#define a Crate_virus_use_python_code
#define bin Use_assembely_program
#define command_prompt_code webconfig_ip_user
//#ifndef not_my_pc hack_user_pc
//#ifndef a hack_pc
#define send mail_to_me_user_info
#define only_my_pc
